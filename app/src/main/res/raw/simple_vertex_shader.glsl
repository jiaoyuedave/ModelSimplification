...
//uniform vec3 u_LightLocation;              // 定位光位置
uniform vec3 u_LightDirection;            // 定向光方位
...
//    pointLight(normalize(a_Normal),ambientTemp,diffuseTemp,specularTemp,u_LightLocation,vec4(0.1,0.1,0.1,1.0),vec4(0.7,0.7,0.7,1.0),vec4(0.3,0.3,0.3,1.0));
    directionalLight(normalize(a_Normal),ambientTemp,diffuseTemp,specularTemp,u_LightDirection,
            vec4(0.3,0.3,0.3,1.0),vec4(0.6,0.6,0.6,1.0),vec4(0.5,0.5,0.5,1.0));
